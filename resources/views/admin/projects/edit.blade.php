            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="tab-content mt-3" id="langTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="en" role="tabpanel">
                            <div class="form-group mb-3">
                                <label>Name (EN)</label>
                                <input type="text" name="name_en" class="form-control" value="{{ old('name_en', $project->name_en) }}" required>
                            </div>

                            <div class="form-group mb-3">
                                <label>Description (EN)</label>
                                <textarea name="description_en" class="form-control" rows="4">{{ old('description_en', $project->description_en) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="ar" role="tabpanel">
                            <div class="form-group mb-3">
                                <label>Name (AR)</label>
                                <input type="text" name="name_ar" class="form-control" value="{{ old('name_ar', $project->name_ar) }}" required>
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if($project->image)
                            <img src="{{ asset('storage/' . $project->image) }}" width="120" class="mb-2">
                        @endif
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="subcategory_id" class="form-control">
                            ...
                            @foreach($subcategories as $subcategory)
                                <option value="{{ $subcategory->id }}" {{ $project->subcategory_id == $subcategory->id ? 'selected' : '' }}>
                                    {{ $subcategory->name_en }}
                                </option>
                            @endforeach
                        </select>
