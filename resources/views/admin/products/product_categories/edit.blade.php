        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <form action="{{ route('admin.product_categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="tab-content mt-3" id="editLangTabsContent">
                        <!-- English Tab -->
                        ...
                        <div class="tab-pane fade" id="ar" role="tabpanel" aria-labelledby="tab-ar">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="description_ar" class="form-control" rows="4">{{ old('description_ar', $category->description_ar) }}</textarea>
                            </div>
                        </div>
