                    ...
                    <div class="tab-content mt-3" id="langTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="en" role="tabpanel">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="title_en" class="form-control" value="{{ old('title_en', $stat->title_en) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="ar" role="tabpanel">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="title_ar" class="form-control" value="{{ old('title_ar', $stat->title_ar) }}" required>
                            </div>
                        </div>
                    </div>
