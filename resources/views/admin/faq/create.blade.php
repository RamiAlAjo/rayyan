...
<div class="row">
    <div class="col-xl-12">
        <div class="card shadow-sm mb-3">
            <div class="card-body">
                <h5 class="card-title pt-2 text-dark font-weight-bold">Create FAQ</h5>
                    ...
                    <div class="tab-content" id="langTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="lang-en" role="tabpanel" aria-labelledby="tab-en">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control shadow-sm" name="question_en" id="question_en" value="{{ old('question_en') }}">
                                @error('question_en')
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea class="form-control shadow-sm" name="answer_en" id="answer_en" rows="4">{{ old('answer_en') }}</textarea>
                                @error('answer_en')
                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="tab-pane fade" id="lang-ar" role="tabpanel" aria-labelledby="tab-ar">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control shadow-sm text-end" name="question_ar" id="question_ar" value="{{ old('question_ar') }}">
                                @error('question_ar')
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea class="form-control shadow-sm text-end" name="answer_ar" id="answer_ar" rows="4">{{ old('answer_ar') }}</textarea>
                                @error('answer_ar')
                                    <div class="alert alert-danger mt-2 text-end">{{ $message }}</div>
                                @enderror
                            </div>
