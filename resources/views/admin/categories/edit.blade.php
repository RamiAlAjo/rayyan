                    ...
                    <div class="tab-content" id="categoryTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="en" role="tabpanel" aria-labelledby="en-tab">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description_en" id="description_en" class="form-control" rows="4">{{ old('description_en', $category->description_en) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="ar" role="tabpanel" aria-labelledby="ar-tab">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description_ar" id="description_ar" class="form-control" rows="4">{{ old('description_ar', $category->description_ar) }}</textarea>
                            </div>
                        </div>
                    </div>
